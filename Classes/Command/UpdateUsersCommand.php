...
class UpdateUsersCommand extends Command
{
    ...
    public function configure()
    {
        $this
            ...
            ->setHelp(
                'Existing users will be updated with data from LDAP servers.'
            )
            ->addArgument(
                'servers',
            ...
            ->addArgument(
                'processFe',
                InputArgument::REQUIRED,
                '[Boolean] Update frontend users'
            )
            ->addArgument(
                'processBe',
                InputArgument::REQUIRED,
                '[Boolean] Update backend users'
            )
        ;
    }

    /**
     * Executes the command to update LDAP users.
     */
